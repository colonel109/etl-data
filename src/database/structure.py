...
class Transactions(Base):
    ...
    weight: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4))
    uom_per_quantity: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4))
    uom_quantity: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4))
    quantity: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4))
    quantity_packaging_uom: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4))
    box: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4))
    base_price: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4))
